    ...
    function write_detail_wrap(new_order_detail,detail_wrap,order_arr, order_operation_txt){
        ...
        var new_detail_wrap = detail_wrap.cloneNode(true);// 获取单个订单容器下的值
            ...
            new_detail_wrap.querySelector('.goods_pic').src = order_arr['goods_small_logo'];// 商品图片
            new_detail_wrap.querySelector('.goods_name_txt').innerHTML = order_arr['goods_name'];// 商品名称
            new_detail_wrap.querySelector('.goods_attr_txt').innerHTML = goods_attr_text;// 商品属性
            new_detail_wrap.querySelector('.goods_simple_price_txt').innerHTML = order_arr['goods_price'];// 商品单价
            ...
            if(order_operation_txt == '付款')      
                new_detail_wrap.querySelector('.order_operation_txt').href = "pay.php?order_id=" + order_arr['order_id'] + "&order_price=" + order_arr['total_price'] + "&single=1" ;// 订单操作
