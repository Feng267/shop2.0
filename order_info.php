...
<!--页面顶部-->
    ...
    <div id="order_content_body">
		<ul id="c_list">
			<li class="bg_c"><a href="#">所有订单</a></li>
			<li class=""><a href="#">待付款</a></li>
			<li class=""><a href="#">待发货</a></li>
			<li class=""><a href="#">待收货</a></li>
			<li class=""><a href="#">待评价</a></li>
        </ul>
                            ...
                            <div class="detail_body">
                                <ul class="detail_body_ul">
                                    <li>
                                        ...
                                        <!-- <a> -->
                                            <div class="goods_pic_wrap"><img src="" onerror="imgError()" class="goods_pic"></div>
                                            <div class="goods_content_wrap">
                                                <div>
                                                    ...
                                                    <span class="goods_serv_wrap">
                                                        <img src="img/authentic-16-16.png" alt="">
                                                        <img src="img/real-16-16.png" alt="">
                                                        <img src="img/seven-16-16.png" alt="">
                                                    </span>
