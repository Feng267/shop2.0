...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/base.css" /><!-- 基础样式 -->
...
<body>
    ...
    <div id="big_frame">
                ...
                <div class="icon">
                    <div class="layui-upload">
                        <div class="layui-upload-list">
                            <img class="layui-upload-img" name="img" id="demo1" src="img/head_pic/default.jpg">
                            <p id="demoText"></p>
                        </div>
        ...
        <!-- <?php include 'api/user/update.php'?>   提交页面 -->
    </div>
